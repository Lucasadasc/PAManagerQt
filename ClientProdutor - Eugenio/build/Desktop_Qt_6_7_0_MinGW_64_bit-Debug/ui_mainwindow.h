...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QObject::connect(horizontalSliderMinimo, SIGNAL(sliderMoved(int)), lcdNumberMinimo, SLOT(display(int)));
        QObject::connect(horizontalSliderMaximo, SIGNAL(sliderMoved(int)), lcdNumberMaximo, SLOT(display(int)));
        QObject::connect(horizontalSliderTempo, SIGNAL(sliderMoved(int)), lcdNumber, SLOT(display(int)));
        ...
        QObject::connect(horizontalSliderTempo, SIGNAL(valueChanged(int)), lcdNumber, SLOT(display(int)));
